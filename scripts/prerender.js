...
const prerenderCommand = `npx prerender --source ./dist --dest ./dist --routes ${routesString} --renderer @prerenderer/renderer-puppeteer --renderer-options '{"headless": true, "args": ["--no-sandbox", "--disable-setuid-sandbox"]}'`;
